...
Route::prefix('apps')->group(function() {
    ...
    Route::group(['middleware' => ['auth']], function () {
        ...
        Route::get('/categories/import', [\App\Http\Controllers\Apps\CategoryController::class, 'import'])
            ->middleware('permission:categories.import')
            ->name('apps.categories.import');

        Route::post('/categories/importStore', [\App\Http\Controllers\Apps\CategoryController::class, 'importStore'])
            ->middleware('permission:categories.import')
            ->name('categories.import.store');
            
        Route::resource('/categories', \App\Http\Controllers\Apps\CategoryController::class, ['as' => 'apps'])
            ->middleware('permission:categories.index|categories.create|categories.edit|categories.delete|categories.import');    
        ...
        Route::get('/customers/import', [\App\Http\Controllers\Apps\CustomerController::class, 'import'])
        ->middleware('permission:customers.import')
        ->name('apps.customers.import');

        Route::post('/customers/importStore', [\App\Http\Controllers\Apps\CustomerController::class, 'importStore'])
        ->middleware('permission:customers.import')
