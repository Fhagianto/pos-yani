    ...
    <div class="c-app">
      <div class="c-sidebar c-sidebar-dark c-sidebar-fixed" :class="{ 'c-sidebar-lg-show': !$page.url.startsWith('/apps/transactions') }" id="sidebar">
        <div class="c-sidebar-brand d-lg-down-none" style="background: #894b9d;">
          ...
          <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap/5.3.0/css/bootstrap.min.css">
          <img src="/images/cash-machine.png" class="bg-light rounded shadow-sm p-1" width="35"> <span class="ml-2 font-weight-bold">Yani Grocer</span>
        </div>
      ...
      <div class="c-wrapper c-fixed-components">
        ...
        <div class="c-body">
          ...
          <footer class="c-footer">
            <div><strong>Yani Grocer</strong> &copy; 2024 - sayafadlimanh</div>
          </footer>
        </div>
      </div>
    </div>
