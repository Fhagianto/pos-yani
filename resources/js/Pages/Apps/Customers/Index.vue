                            ...
                            <div class="card-body">
                                <form @submit.prevent="handleSearch">
                                    <div class="input-group mb-3">
                                        ...
                                        <Link href="/apps/customers/import" v-if="hasAnyPermission(['customers.import'])" class="btn btn-success input-group-text"> <i class="fa fa-plus-circle me-2"></i> Import</Link>
